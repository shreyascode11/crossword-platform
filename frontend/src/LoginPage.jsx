...
const LoginPage = () => {
  ...
  return (
    // Radial gradient background and base padding
          ...
          <div className="bg-gradient-to-br from-[#E53935]/15 to-[#141414]/60 backdrop-blur-xl border border-white/5 border-t-white/15 border-l-white/15 shadow-[0_8px_32px_0_rgba(229,57,53,0.25)] rounded-3xl p-10 w-full box-border transition-all duration-300 ease-in-out hover:-translate-y-1 hover:shadow-[0_15px_40px_0_rgba(229,57,53,0.35)]">
            ...
            <form onSubmit={handleLogin} className="flex flex-col gap-6">
              <input 
                ...
                className="bg-black/50 border border-white/5 rounded-xl p-4 text-white text-base transition-all duration-300 shadow-inner placeholder:text-gray-500 focus:outline-none focus:border-[var(--color-crox-red)] focus:bg-[#E53935]/5 focus:shadow-[0_0_15px_rgba(229,57,53,0.2)]"
                required
              />
              <input 
                type="password" 
